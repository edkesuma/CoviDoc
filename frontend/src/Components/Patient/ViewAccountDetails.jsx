...
function ViewAccountDetails({patientDetails}) {
    ...
    return (
        <div className="p-6 sm:p-10 bg-white rounded-lg shadow-lg relative w-full hover:shadow-xl transition duration-300">
            <div className="flex flex-col md:flex-row space-x-6">
                {/* Column 1: Image and Basic Info */}
                <div className="flex flex-col items-center w-full md:w-4/12 md:items-start">
                ...
                {/* Column 2: Allergies and Medical History */}
                <div className="flex flex-col my-4 md:w-5/12 md:mt-0">
                    <div className="w-full md:h-1/2 my-4">
                ...
                <div className="flex justify-center items-start w-full md:w-2/12 mt-4 md:mt-0">
                    <button
